...
[ExecuteInEditMode]
public class TerrainSetUp512 : MonoBehaviour 
{
	public bool start_b = true,end_b = false;
	Terrain terrain;
	TerrainData terrainData;
	TerrainSetUp512 terrainset;

	// Use this for initialization
	void Start () 
    {
		terrain = GetComponent<Terrain> ();
		terrainset = GetComponent<TerrainSetUp512>();
		start_b = true;
	}
	...
	void Update () 
    {
		...
		{
			terrain.terrainData.size = new Vector3(512,140,512);
